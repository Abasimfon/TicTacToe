...
public class chooseSides5x5 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_choose_sides5x5);
    ...
    private void onPlayButtonClickListener() {
        ...
        progressToGame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(chooseSides5x5.this, five_boards_player_vs_anotherhumanplayer.class));
            }
        });
    }
}
